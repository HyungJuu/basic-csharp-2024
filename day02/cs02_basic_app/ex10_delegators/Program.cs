namespace ex10_delegators
{
    ...
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            // 일반적인 함수 호출에서는 한번에 여러개의 함수 실행이 불가능하다.
            ...
            notifier.EventOccured -= listener2.SomethingHappened;   // 리스터2의 함수 실행x
            ...
            Callback = new MyDelegate(calc.Plus);   // int a, int b 가 아닌 Calculator 객체의 Plus() 메서드를 전달
